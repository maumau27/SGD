...
@csrf
    ...
    <div class="container mt-5">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name="Nome" placeholder="Login" required>
        ...
        <div class="form-floating mb-3">
            <input type="password" class="form-control" name="SenhaConfirma"  placeholder="SenhaConfirma" required>
        ...
        <div class="container-fluid mb-2">
            <?php $cols = 4; $i = $cols - 1; foreach($Perfils as $perfil): ?>
                ...
                <div class="col form-check mb-2">
                    <div class="flex">
                        <input class="btn-check" type="checkbox" value="{{$perfil->id}}" name="Perfil[{{$perfil->id}}]" id="{{$perfil->Codigo}}" autocomplete="off">
